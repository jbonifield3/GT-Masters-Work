<?php
    ...
    define('DB_PORT', "3306");                    //The port #. It is always 3306
    define('DB_USER', "dccakes");                //Your  username
    define('DB_PASS', "");                       //Remember, there is NO password by default!
    //define('DB_USER', "root");                //Your  username
    //define('DB_PASS', "super22");                       //Remember, there is NO password by default!
    define('DB_SCHEMA', "cs6400_su18_team04");   //Your database name you want to connect to
